        ...
        >
          <CardContent>
            <Container maxWidth={false}>
                    ...
                    {rows.map((row) => (
                      <StyledTableRow key={row.address}>
                        ...
                        <StyledTableCell align="left">
                          <Button sx={{ marginY: '1px', width: '100%' }} variant="contained">
                            Edit
                          </Button>
                          <Button sx={{ marginY: '5px', width: '100%' }} variant="contained">
                            Remove
                          </Button>
                          <Button sx={{ marginY: '5px', width: '100%' }} variant="contained">
                            View
              ...
              <Button sx={{ marginY: '5px' }} variant="contained">
                Add
              </Button>
              ...
              <TableContainer component={Paper} sx={{ marginBottom: '50px' }}>
                <Table sx={{ maxWidth: '100%' }} aria-label="customized table">
                  <TableHead>
                    <TableRow>
                      <StyledTableCell align="left">Pay Type</StyledTableCell>
...
// Pay.getLayout = (page) => <DashboardLayout>{page}</DashboardLayout>;
