            ...
            <ul className="nav user-menu">
              ...
              <li className="nav-item dropdown">
                ...
                <div className="dropdown-menu notifications">
                  ...
                  <div className="topnav-dropdown-footer">
                    <a href="/orange/conversation/chat">View all Messages</a>
                  </div>
                </div>
              </li>
              {/* /Message Notifications */}
              <li className="nav-item dropdown has-arrow main-drop">
                ...
                <div className="dropdown-menu">
                  <a className="dropdown-item" href="/orange/app/profile/employee-profile">My Profile</a>
                  <a className="dropdown-item" href="/orange/settings/companysetting">Settings</a>
                  <a className="dropdown-item" href="/orange/login">Logout</a>
                </div>
              </li>
            </ul>
            {/* /Header Menu */}
