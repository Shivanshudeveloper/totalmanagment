              ...
              <div className="fixed-header">
                <div className="navbar">
                  ...
                  <ul className="nav custom-menu">
                    ...
                    <li className="nav-item">
                      <a href="/orange/conversation/voice-call" className="nav-link"><i className="fa fa-phone" /></a>
                    </li>
                    <li className="nav-item">
                      <a href="/orange/conversation/video-call" className="nav-link"><i className="fa fa-video-camera" /></a>
                    </li>
                      ...
                      <div className="chats">
                        ...
                        <div className="chat chat-left">
                          <div className="chat-avatar">
                            <a href="/orange/app/profile/employee-profile" className="avatar">
