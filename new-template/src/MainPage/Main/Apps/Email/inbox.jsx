        ...
        <div className="page-header">
          <div className="row align-items-center">
            ...
            <div className="col-auto float-right ml-auto">
              <a href="/orange/email/compose" className="btn add-btn"><i className="fa fa-plus" /> Compose</a>
            </div>
          </div>
        </div>
        {/* /Page Header */}
                ...
                <div className="email-content">
                  <div className="table-responsive">
                    <table className="table table-inbox table-hover">
                      ...
                      <tbody>
                        <tr className="unread clickable-row" data-href="/orange/email/mail-view">
                          <td>
                        ...
                        <tr className="clickable-row" data-href="/orange/email/mail-view">
                          <td>
                            <input type="checkbox" className="checkmail" />
                          </td>
                          <td><span className="mail-important"><i className="fa fa-star-o" /></span></td>
