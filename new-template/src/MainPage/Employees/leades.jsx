   ...
   render() {
    ...
    const columns = [
    ...
    
      {
        ...
        dataIndex: 'project',
        render: (text, record) => (
        <a href="/orange/app/projects/projects-view">{text}</a>
          ),
                 ...
                 {/* <table className="table table-striped table-nowrap custom-table mb-0 datatable">
                   ...
                   <tbody>
                     <tr>
                       ...
                       <td>9876543210</td>
                       <td><a href="/orange/app/projects/projects-view">Hospital Administration</a></td>
                       <td>
                         <ul className="team-members">
                           <li>
                             <a href="#" title="John Doe" data-toggle="tooltip"><img alt="" src={Avatar_02} /></a>
                     ...
                     <tr>
                       ...
                       <td>9876543210</td>
                       <td><a href="/orange/app/projects/projects-view">Video Calling App</a></td>
                       <td>
                         <ul className="team-members">
                           <li>
                             <a href="#" title="John Doe" data-toggle="tooltip"><img alt="" src={Avatar_02} /></a>
                     ...
                     <tr>
                       ...
                       <td>9876543210</td>
                       <td><a href="/orange/app/projects/projects-view">Office Management</a></td>
                       <td>
                         <ul className="team-members">
                           <li>
                             <a href="#" title="John Doe" data-toggle="tooltip"><img alt="" src={Avatar_02} /></a>
