      ...
      
      {
        ...
        render: (text, record) => (            
            <h2 className="table-avatar">
              ...
              <a href="/orange/app/profile/employee-profile">{text}</a>
            </h2>
          ), 
             ...
             <div className="row align-items-center">
               ...
               <div className="col-auto float-right ml-auto">
                 ...
                 <div className="view-icons">
                   <a href="/orange/app/employees/clients" className="grid-view btn btn-link"><i className="fa fa-th" /></a>
                   <a href="/orange/app/employees/clients-list" className="list-view btn btn-link active"><i className="fa fa-bars" /></a>
                 </div>
               </div>
             </div>
           </div>
                 ...
                 {/* <table className="table table-striped custom-table datatable">
                   ...
                   <tbody>
                     <tr>
                       <td>
                         <h2 className="table-avatar">
                           <a href="/orange/app/profile/client-profile" className="avatar"><img src={Avatar_19} alt="" /></a>
                           <a href="/orange/app/profile/client-profile">Global Technologies</a>
                         </h2>
                       </td>
                       <td>CLT-0001</td>
                       <td>Barry Cuda</td>
                     ...
                     <tr>
                       <td>
                         <h2 className="table-avatar">
                           <a href="/orange/app/profile/client-profile" className="avatar"><img src={Avatar_29} alt="" /></a>
                           <a href="/orange/app/profile/client-profile">Delta Infotech</a>
                         </h2>
                       </td>
                       <td>CLT-0002</td>
                       <td>Tressa Wexler</td>
                     ...
                     <tr>
                       <td>
                         <h2 className="table-avatar">
                           <a href="/orange/app/profile/client-profile" className="avatar"><img alt="" src={Avatar_07} /></a>
                           <a href="/orange/app/profile/client-profile">Cream Inc</a>
                         </h2>
                       </td>
                       <td>CLT-0003</td>
                       <td>Ruby Bartlett</td>
                     ...
                     <tr>
                       <td>
                         <h2 className="table-avatar">
                           <a href="/orange/app/profile/client-profile" className="avatar"><img alt="" src={Avatar_06} /></a>
                           <a href="/orange/app/profile/client-profile">Wellware Company</a>
                         </h2>
                       </td>
                       <td>CLT-0004</td>
                       <td>Misty Tison</td>
                     ...
                     <tr>
                       <td>
                         <h2 className="table-avatar">
                           <a href="/orange/app/profile/client-profile" className="avatar"><img src={Avatar_14} alt="" /></a>
                           <a href="/orange/app/profile/client-profile">Mustang Technologies</a>
                         </h2>
                       </td>
                       <td>CLT-0005</td>
                       <td>Daniel Deacon</td>
                     ...
                     <tr>
                       <td>
                         <h2 className="table-avatar">
                           <a href="/orange/app/profile/client-profile" className="avatar"><img src={Avatar_18} alt="" /></a>
                           <a href="/orange/app/profile/client-profile">International Software Inc</a>
                         </h2>
                       </td>
                       <td>CLT-0006</td>
                       <td>Walter Weaver</td>
                     ...
                     <tr>
                       <td>
                         <h2 className="table-avatar">
                           <a href="/orange/app/profile/client-profile" className="avatar"><img src={Avatar_28} alt="" /></a>
                           <a href="/orange/app/profile/client-profile">Mercury Software Inc</a>
                         </h2>
                       </td>
                       <td>CLT-0007</td>
                       <td>Amanda Warren</td>
                     ...
                     <tr>
                       <td>
                         <h2 className="table-avatar">
                           <a href="/orange/app/profile/client-profile" className="avatar"><img src={Avatar_22} alt="" /></a>
                           <a href="/orange/app/profile/client-profile">Carlson Tech</a>
                         </h2>
                       </td>
                       <td>CLT-0008</td>
                       <td>Betty Carlson</td>
