   ...
   render() {
    ...
    const columns = [
      ...
      },
      {
        ...
        dataIndex: 'ticketid',
        render: (text, record) => (            
          <a href="/orange/app/employees/ticket-view">#TKT-0001</a>
          ), 
                ...
                <Table className="table-striped"
                  ...
                  {/* <table className="table table-striped custom-table mb-0 datatable">
                    ...
                    <tbody>
                      <tr>
                        <td>1</td>
                        <td><a href="/orange/app/employees/ticket-view">#TKT-0001</a></td>
                        <td>Laptop Issue</td>
                        <td>
                          <h2 className="table-avatar">
                      ...
                      <tr>
                        ...
                        <td>
                          <h2 className="table-avatar">
                            <a className="avatar avatar-xs" href="/orange/app/profile/employee-profile"><img alt="" src={Avatar_08} /></a>
