              ...
              <div className="row">
                <div className="col">
                  ...
                  <ul className="breadcrumb">
                    ...
                    <li className="breadcrumb-item"><a href="/orange/app/employee/allemployees">Employees</a></li>
                    <li className="breadcrumb-item active">Shift Scheduling</li>
                  </ul>
                </div>
                <div className="col-auto float-right ml-auto">
                  <a href="/orange/app/employee/shift-list" className="btn add-btn m-r-5">Shifts</a>
                  ...
                  <table className="table table-striped custom-table">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <h2 className="table-avatar">
                            <a href="/orange/app/profile/employee-profile" className="avatar"><img src={Avatar_02} /></a>
                      ...
                      <tr>
                        <td>
                          <h2 className="table-avatar">
                            <a href="/orange/app/profile/employee-profile" className="avatar"><img src={Avatar_09} /></a>
                      ...
                      <tr>
                        <td>
                          <h2 className="table-avatar">
                            <a href="/orange/app/profile/employee-profile" className="avatar"><img src={Avatar_10} /></a>
                      ...
                      <tr>
                        <td>
                          <h2 className="table-avatar">
                            <a href="/orange/app/profile/employee-profile" className="avatar"><img src={Avatar_05} /></a>
                      ...
                      <tr>
                        <td>
                          <h2 className="table-avatar">
                            <a href="/orange/app/profile/employee-profile" className="avatar"><img src={Avatar_11} /></a>
                      ...
                      <tr>
                        <td>
                          <h2 className="table-avatar">
                            <a href="/orange/app/profile/employee-profile" className="avatar"><img src={Avatar_12} /></a>
                      ...
                      <tr>
                        <td>
                          <h2 className="table-avatar">
                            <a href="/orange/app/profile/employee-profile" className="avatar"><img src={Avatar_13} /></a>
