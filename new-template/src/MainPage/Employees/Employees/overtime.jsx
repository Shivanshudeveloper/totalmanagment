 ...
 const{data} = this.state
      const columns = [
      ...
      
        {
          ...
          render: (text, record) => (            
              <h2 className="table-avatar">
                <a href="/orange/app/profile/employee-profile" className="avatar"><img alt="" src={record.apimage} /></a>
              ...
              {/* <table className="table table-striped custom-table mb-0 datatable">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <h2 className="table-avatar">
                        <a href="/orange/app/profile/employee-profile" className="avatar avatar-xs"><img src={Avatar_09} alt="" /></a>
