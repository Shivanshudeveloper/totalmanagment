              ...
              {/* <table className="table table-striped custom-table mb-0 datatable">
                ...
                <tbody>
                  ...
                  <tr>
                    <td>
                      <h2 className="table-avatar">
                        <a href="/orange/app/profile/employee-profile" className="avatar"><img alt="" src={Avatar_24} /></a>
                  ...
                  <tr>
                    <td>
                      <h2 className="table-avatar">
                        <a href="/orange/app/profile/employee-profile" className="avatar"><img alt="" src={Avatar_15} /></a>
                  ...
                  <tr>
                    <td>
                      <h2 className="table-avatar">
                        <a href="/orange/app/profile/employee-profile" className="avatar"><img alt="" src={Avatar_20} /></a>
                  ...
                  <tr>
                    <td>
                      <h2 className="table-avatar">
                        <a href="/orange/app/profile/employee-profile" className="avatar"><img alt="" src={Avatar_25} /></a>
