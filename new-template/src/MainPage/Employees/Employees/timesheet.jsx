        ...
        
        {
          ...
          render: (text, record) => (            
              <h2 className="table-avatar">
                <a href="/orange/app/profile/employee-profile" className="avatar"><img alt="" src={record.image} /></a>
                <a href="/orange/app/profile/employee-profile">{text} <span>{record.role}</span></a>
              </h2>
            ), 
                      ...
                      {/* <table className="table table-striped custom-table mb-0 datatable">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td>
                              <h2 className="table-avatar">
                                ...
                                <a href="/orange/app/profile/employee-profile">Richard Miles <span>Web Developer</span></a>
                              </h2>
                            </td>
                            <td>8 Mar 2019</td>
                            <td>
                          ...
                          <tr>
                            <td>
                              <h2 className="table-avatar">
                                <a href="/orange/app/profile/employee-profile" className="avatar"><img alt="" src={Avatar_12} /></a>
                                <a href="/orange/app/profile/employee-profile">Jeffrey Warden <span>Web Developer</span></a>
                              </h2>
                            </td>
                            <td>8 Mar 2019</td>
                            <td>
                          ...
                          <tr>
                            <td>
                              <h2 className="table-avatar">
                                <a href="/orange/app/profile/employee-profile" className="avatar"><img alt="" src={Avatar_13} /></a>
                                <a href="/orange/app/profile/employee-profile">Bernardo Galaviz <span>Web Developer</span></a>
                              </h2>
                            </td>
                            <td>8 Mar 2019</td>
                            <td>
                          ...
                          <tr>
                            <td>
                              <h2 className="table-avatar">
                                <a href="/orange/app/profile/employee-profile" className="avatar"><img alt="" src={Avatar_01} /></a>
                                <a href="/orange/app/profile/employee-profile">Lesley Grauer <span>Team Leader</span></a>
                              </h2>
                            </td>
                            <td>8 Mar 2019</td>
                            <td>
                          ...
                          <tr>
                            <td>
                              <h2 className="table-avatar">
                                <a href="/orange/app/profile/employee-profile" className="avatar"><img alt="" src={Avatar_16} /></a>
                                <a href="/orange/app/profile/employee-profile">Jeffery Lalor <span>Team Leader</span></a>
                              </h2>
                            </td>
                            <td>8 Mar 2019</td>
                            <td>
                          ...
                          <tr>
                            <td>
                              <h2 className="table-avatar">
                                <a href="/orange/app/profile/employee-profile" className="avatar"><img alt="" src={Avatar_04} /></a>
                                <a href="/orange/app/profile/employee-profile">Loren Gatlin <span>Android Developer</span></a>
                              </h2>
                            </td>
                            <td>8 Mar 2019</td>
                            <td>
                          ...
                          <tr>
                            <td>
                              <h2 className="table-avatar">
                                <a href="/orange/app/profile/employee-profile" className="avatar"><img alt="" src={Avatar_03} /></a>
                                <a href="/orange/app/profile/employee-profile">Tarah Shropshire <span>Android Developer</span></a>
                              </h2>
                            </td>
                            <td>8 Mar 2019</td>
                            <td>
                          ...
                          <tr>
                            <td>
                              <h2 className="table-avatar">
                                <a href="/orange/app/profile/employee-profile" className="avatar"><img alt="" src={Avatar_08}/></a>
                                <a href="/orange/app/profile/employee-profile">Catherine Manseau <span>Android Developer</span></a>
                              </h2>
                            </td>
                            <td>8 Mar 2019</td>
                            <td>
