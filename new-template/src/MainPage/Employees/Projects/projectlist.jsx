          ...
          <div className="row align-items-center">
            ...
            <div className="col-auto float-right ml-auto">
              ...
              <div className="view-icons">
                <a href="/orange/app/projects/project_dashboard" className="grid-view btn btn-link"><i className="fa fa-th" /></a>
                <a href="/orange/app/projects/projects-list" className="list-view btn btn-link active"><i className="fa fa-bars" /></a>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="table-responsive">
              <table className="table table-striped custom-table datatable">
                ...
                <tbody>
                  <tr>
                    <td>
                      <a href="/orange/app/projects/projects-view">Office Management</a>
                    </td>
                    <td>PRO-0001</td>
                    <td>
                  ...
                  <tr>
                    <td>
                      <a href="/orange/app/projects/projects-view">Project Management</a>
                    </td>
                    <td>PRO-0002</td>
                    <td>
                      <ul className="team-members">
                  ...
                  <tr>
                    <td>
                      <a href="/orange/app/projects/projects-view">Video Calling App</a>
                    </td>
                    <td>PRO-0003</td>
                    <td>
                      <ul className="team-members">
                  ...
                  <tr>
                    <td>
                      <a href="/orange/app/projects/projects-view">Hospital Administration</a>
                    </td>
                    <td>PRO-0004</td>
                    <td>
                      <ul className="team-members">
