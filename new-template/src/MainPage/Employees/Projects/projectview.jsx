        ...
        <div className="page-header">
          <div className="row align-items-center">
            ...
            <div className="col-auto float-right ml-auto">
              ...
              <a href="/orange/app/projects/task-board" className="btn btn-white float-right m-r-10" data-toggle="tooltip" title="Task Board"><i className="fa fa-bars" /></a>
            </div>
          </div>
        </div>
        {/* /Page Header */}
              ...
              <div className="card-body">
                ...
                <table className="table table-striped table-border">
                  <tbody>
                    ...
                    <tr>
                      <td>Created by:</td>
                      <td className="text-right"><a href="/orange/app/profile/employee-profile">Barry Cuda</a></td>
                    </tr>
                    <tr>
                      <td>Status:</td>
