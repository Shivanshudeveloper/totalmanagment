                ...
                <div className="col-md-6 offset-md-3">
                    ...
                    <div className="card-body">
                        ...
                        <div className="col-md-6 text-center m-b-30">
                            <a href="/orange/app/administrator/questions" className="btn btn-primary btn-block submit-btn">Html</a>
                        </div>
                        <div className="col-md-6 text-center m-b-30">
                            <a href="/orange/app/administrator/questions" className="btn btn-primary btn-block submit-btn">Css</a>
                        </div>
                        <div className="col-md-6 text-center m-b-30">
                            <a href="/orange/app/administrator/questions" className="btn btn-primary btn-block submit-btn">Design</a>
                        </div>
                        <div className="col-md-6 text-center m-b-30">
                            <a href="/orange/app/administrator/questions" className="btn btn-primary btn-block submit-btn">Javascript</a>
                        </div>
                        </div>
                    </div>
                    </div>
