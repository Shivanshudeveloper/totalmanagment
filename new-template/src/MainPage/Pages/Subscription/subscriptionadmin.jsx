                                ...
                                <table className="table table-hover table-center mb-0">
                                  ...
                                  <tbody>
                                    <tr>
                                      ...
                                      <td>8 Dec 2019</td>
                                      <td>Free</td>
                                      <td><a className="btn btn-info btn-sm" href="/orange/app/subscription/subscribedcompanies">30 Users</a></td>
                                    </tr>
                                    <tr>
                                      <td>Professional</td>
                                      <td>Monthly</td>
                                      ...
                                      <td>8 Dec 2019</td>
                                      <td>$21</td>
                                      <td><a className="btn btn-info btn-sm" href="/orange/app/subscription/subscribedcompanies">97 Users</a></td>
                                    </tr>
                                    <tr>
                                      <td>Enterprise</td>
                                      <td>Monthly</td>
                                      ...
                                      <td>8 Dec 2019</td>
                                      <td>$38</td>
                                      <td><a className="btn btn-info btn-sm" href="/orange/app/subscription/subscribedcompanies">125 Users</a></td>
                                    </tr>
                                  </tbody>
                                </table>
                              </div>
                                ...
                                <table className="table table-hover table-center mb-0">
                                  ...
                                  <tbody>
                                    <tr>
                                      ...
                                      <td>8 Dec 2019</td>
                                      <td>Free</td>
                                      <td><a className="btn btn-info btn-sm" href="/orange/app/subscription/subscribedcompanies">62 Users</a></td>
                                    </tr>
                                    <tr>
                                      <td>Professional</td>
                                      <td>Yearly</td>
                                      ...
                                      <td>8 Dec 2019</td>
                                      <td>$199</td>
                                      <td><a className="btn btn-info btn-sm" href="/orange/app/subscription/subscribedcompanies">157 Users</a></td>
                                    </tr>
                                    <tr>
                                      <td>Enterprise</td>
                                      <td>Yearly</td>
                                      ...
                                      <td>8 Dec 2019</td>
                                      <td>$399</td>
                                      <td><a className="btn btn-info btn-sm" href="/orange/app/subscription/subscribedcompanies">241 Users</a></td>
                                    </tr>
                                  </tbody>
                                </table>
                              </div>
