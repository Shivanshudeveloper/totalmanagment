                ...
                {/* <table className="table table-striped custom-table mb-0 datatable">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <h2 className="table-avatar">
                          <a href="/orange/app/profile/employee-profile" className="avatar avatar-xs"><img src={Avatar_04} alt="" /></a>
                    ...
                    <tr>
                      ...
                      <td>
                        <h2 className="table-avatar">
                          <a href="/orange/app/profile/employee-profile" className="avatar avatar-xs"><img src={Avatar_03} alt="" /></a>
                          <a href="/orange/app/profile/employee-profile">Tarah Shropshire</a>
                        </h2>
                      </td>
                      <td>$1215</td>
                      <td>Cheque</td>
