   ...
   render() {
    ...
    const columns = [
      ...
      },      
      {
        ...
        render: (text, record) => (
          <a href="/orange/app/sales/invoices-view">#{text}</a>
          ),
            ...
            <div className="dropdown dropdown-action text-right">
                <a href="#" className="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i className="material-icons">more_vert</i></a>
                        <div className="dropdown-menu dropdown-menu-right">
                          <a className="dropdown-item" href="/orange/app/sales/invoices-edit"><i className="fa fa-pencil m-r-5" /> Edit</a>
                          <a className="dropdown-item" href="/orange/app/sales/invoices-view"><i className="fa fa-eye m-r-5" /> View</a>
        ...
        <div className="page-header">
          <div className="row align-items-center">
            ...
            <div className="col-auto float-right ml-auto">
              <a href="/orange/app/sales/invoices-create" className="btn add-btn"><i className="fa fa-plus" /> Create Invoice</a>
            </div>
          </div>
        </div>
        {/* /Page Header */}
            ...
            <div className="table-responsive">
              ...
              {/* <table className="table table-striped custom-table mb-0">
                ...
                <tbody>
                  <tr>
                    <td>1</td>
                    <td><a href="/orange/app/sales/invoices-view">#INV-0001</a></td>
                  ...
                  <tr>
                    <td>2</td>
                    <td><a href="/orange/app/sales/invoices-view">#INV-0002</a></td>
                  ...
                  <tr>
                    <td>3</td>
                    <td><a href="/orange/app/sales/invoices-view">#INV-0003</a></td>
                    <td>Cream Inc</td>
                    <td>11 Mar 2019</td>
                    <td>17 Mar 2019</td>
                    <td>$2099</td>
