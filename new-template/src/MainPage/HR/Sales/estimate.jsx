   ...
   render() {
    ...
    const columns = [
            
      {
        ...
        render: (text, record) => (
          <a href="/orange/app/sales/estimatesview">{text}</a>
          ),
            ...
            <div className="dropdown dropdown-action text-right">
                 <a href="#" className="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i className="material-icons">more_vert</i></a>
                  <div className="dropdown-menu dropdown-menu-right">
                    <a className="dropdown-item" href="/orange/app/sales/editestimates"><i className="fa fa-pencil m-r-5" /> Edit</a>
        ...
        <div className="page-header">
          <div className="row align-items-center">
            ...
            <div className="col-auto float-right ml-auto">
              <a href="/orange/app/sales/createestimates" className="btn add-btn"><i className="fa fa-plus" /> Create Estimate</a>
            </div>
          </div>
        </div>
        {/* /Page Header */}
          ...
          <div className="col-md-12">
            <div className="table-responsive">
              ...
              {/* <table className="table table-striped custom-table mb-0">
                ...
                <tbody>
                  <tr>
                    <td><a href="/orange/app/sales/estimatesview">EST-0001</a></td>
                  ...
                  <tr>
                    <td><a href="/orange/app/sales/estimatesview">EST-0002</a></td>
                  ...
                  <tr>
                    <td><a href="/orange/app/sales/estimatesview">EST-0003</a></td>
                    <td>Cream Inc</td>
                    <td>11 Mar 2019</td>
                    <td>17 Mar 2019</td>
                    <td>$2099</td>
                  ...
                  <tr>
                    <td><a href="/orange/app/sales/estimatesview">EST-0004</a></td>
