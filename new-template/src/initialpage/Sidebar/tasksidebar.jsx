        ...
        <div className="sidebar-inner slimscroll">
          <div className="sidebar-menu">
            <ul>
              ...
              <li> 
                <a href="/orange/tasks/tasks">Project Management</a>
              </li>
              <li className="active"> 
                <a href="/orange/tasks/tasks">Hospital Administration</a>
              </li>
              <li> 
                <a href="/orange/tasks/tasks">Video Calling App</a>
              </li>
              <li> 
                <a href="/orange/tasks/tasks">Office Management</a>
              </li>
            </ul>
          </div>
        </div>
