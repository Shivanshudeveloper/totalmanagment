        ...
        return (
          ...
          <div className="header">
            ...
            <ul className="nav user-menu">
              ...
              {/* /Flag */}
              <li className="nav-item">
                <a className="nav-link" href="/orange/login">Login</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="/orange/register">Register</a>
              </li>
            </ul>
            {/* /Header Menu */}
            {/* Mobile Menu */}
            <div className="dropdown mobile-user-menu">
              ...
              <div className="dropdown-menu dropdown-menu-right">
                <a className="dropdown-item" href="/orange/login">Login</a>
                <a className="dropdown-item" href="/orange/register">Register</a>
              </div>
            </div>
            {/* /Mobile Menu */}
          </div>
            ...
            <div className="content container">
              ...
              <div className="row">
                <div className="col-md-6">
                  <a className="job-list" href="/orange/applyjob/jobdetail">
